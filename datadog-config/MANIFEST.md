> **NOTE**:
> These Datadog configurations are designed for demonstration and hackathon purposes.
> Thresholds, queries, and severities are illustrative and would be tuned using
> historical production data in a real deployment.
